...
def test_wrapper_from_wic_participation():
    ...
    assert wrapper.meta.data_bins["natural_breaks"]["wic_participation_women_data"]["total"] == [52.0, 156.0, 364.0, 384.0, 741.0, 780.0]  # noqa: E501
    assert wrapper.meta.data_bins["quantiles"]["wic_participation_women_data"]["total"] == [52.0, 156.0, 364.0, 384.0, 741.0, 780.0]  # noqa: E501

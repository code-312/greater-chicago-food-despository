...
def test_file_to_json():
    try:
        ...
        check_output('tests/resources/Countytest_food_insecurity_xls.json','tests/resources/test_food_insecurity_expected.json')
        check_output('tests/resources/Countytest_food_insecurity_xlsx.json','tests/resources/test_food_insecurity_expected.json')
        check_output('tests/resources/test_food_insecurity_csv.json','tests/resources/test_food_insecurity_expected.json')
    finally:
